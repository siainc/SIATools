...
{
    [self encodeInstanceVariable:object forClass:[object class] customCoder:nil];
}

- (void)encodeInstanceVariable:(id)object forClass:(Class)objectClass customCoder:(BOOL (^)(void *p))customCoder
{
    SIAToolsDLog(@">>object=%@, objectClass=%@, customCoder=%@", object, NSStringFromClass(objectClass), customCoder);
    [object enumerateInstanceVariableForClass:objectClass usingBlock:^(NSString *name, NSString *type, void *address, BOOL *stop) {
...
{
    [self decodeInstanceVariable:object forClass:[object class] customCoder:nil];
}
