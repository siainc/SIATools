...
- (void)localizeSearchBar:(UISearchBar *)searchBar
{
    ...
    NSArray *titles = [searchBar.scopeButtonTitles mappedArray:^id (id obj, NSUInteger idx, BOOL *stop) {
...
- (void)localizeViewController:(UIViewController *)controller
{
    [SILocalization localizeViewController:controller bundle:self];
}

- (void)localizeView:(UIView *)view
{
    SILocalization *localization = [[SILocalization alloc] initWithBundle:self];
