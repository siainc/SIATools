...
@interface SIDateStringViewController ()

@end

@implementation SIDateStringViewController
...
- (IBAction)valueChanged:(id)sender
{
    ...
    self.label4.text = [NSString stringWithFormat:@"%d年 %d月 %d日", picker.date.components.year, picker.date.components.month, picker.date.components.day];
}
